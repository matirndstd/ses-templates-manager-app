...
SES Template Manager is a web application for managing email templates and contact lists using AWS SES (Simple Email Service).
...
1. Clone the repository:
   ```bash
   git clone https://github.com/randstad-argentina/ses-templates-manager-app.git
   cd ses-template-manager-app
